...
function [U,U1,U2,tgrid] = CU3(x,T,ux0,v,dv,q,pce)%xT)%pce)
    ...
    U1(:,1) = ux0(:,1);
    U2(:,1) = ux0(:,2);
    U(:,1) = pce*[U1(:,1) U2(:,1)]';%xT(U1(:,1),U2(:,1));%pce*[U1(:,1) U2(:,1)]';
    ...
    while T-tgrid(tstep) > 0%length(tgrid)<100
        ...
        [uav1,uav2,dt] = CUscheme2(Up1,Up2,dx,q,dv,v);%CU4(Up1,Up2,dx,q,dv,v,xT);
        ...
        Up1(2:end-1) = Up1(2:end-1)+k1_1/2;
        Up2(2:end-1) = Up2(2:end-1)+k1_2/2;
        [uav1,uav2,~] = CUscheme2(Up1,Up2,dx,q,dv,v);
        k2_1 = dt*(uav1);
        k2_2 = dt*(uav2);
        U1(2:end-1,tstep+1)= U1(2:end-1,tstep)+k2_1;
        U2(2:end-1,tstep+1)= U2(2:end-1,tstep)+k2_2;
        ...
        U(:,tstep+1) = pce*[U1(:,tstep+1) U2(:,tstep+1)]';%xT(U1(:,tstep+1),U2(:,tstep+1));%pce*[U1(:,tstep+1) U2(:,tstep+1)]'; 
