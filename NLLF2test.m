...
% Uend1: U(end+1,t)
% U1: U(-1,t)
function [U,U1,U2,tgrid] = NLLF2test(x,T,ux0,v,dv,q,ut0)
    ...
    tgrid(tstep) = 0;
    % Test function
    test = @(x,t) -sin(x).*sin(t)+cos(t).^2.*sin(x).*cos(x);
